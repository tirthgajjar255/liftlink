...
class LTextTheme{
  ...
  static TextTheme lightTextTheme = TextTheme(
      ...
      titleLarge: const TextStyle().copyWith(fontSize: 10.0, fontWeight: FontWeight.w600, color: Colors.black),
  ...
  static TextTheme darkTextTheme = TextTheme(
    ...
    titleLarge: const TextStyle().copyWith(fontSize: 10.0, fontWeight: FontWeight.w600, color: Colors.white),
